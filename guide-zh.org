...
- 安装Emacs 24
- 不要安装任何第三方插件
- 掌握基本知识,什么是环境变量(比如PATH, HOME之类的变量),什么是stdin,什么是stdout,什么是pipe
...
** 精品 Emacs 第三方插件推荐
Emacs第三方插件很多.初学者的问题是装了太多插件,以致插件的管理成了问题.最坏的情况下插件互相冲突,以至于Emacs不能正常启动.

我建议一开始选择插件的原则应该少而精,当你被最优秀的插件培养出了品味后,就能自由挑选适合你自己的插件.
